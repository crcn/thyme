...
var Worker = Structr({
	...
	'__construct': function(workers, channel) {
		...
		this._queue = workers.broker.connect(channel);
		     
		this._id = this._target + ':' + channel;     
	...
	'_nextJob': function() {
		...
		var job = new Job(this._router, this._target, this._channel), self = this;
